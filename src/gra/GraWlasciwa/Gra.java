    ...
    private List<Lokacja> inicjalizacjaLokacji() {
        ...
        lokacjeTMP.add(
                new Lokacja(
                    ...
                    new Wydarzenie(
                            "Lokacja startowa", "Znajdujesz się w swojej chałpce, "
        ...
        lokacjeTMP.add(
                new Lokacja(
                    ...
                    new Wydarzenie("List od Czarnoksieznika", "Dochodzisz do bajkowej polany, księżyc rozpościera"
                    ...
                    List.of(
                        new Wydarzenie(
                                "Walka z zajacem",
                                "Na polanie pojawia sie zajac, to dobra okazja do " +
                                "pocwiczenia walki!", gracz, null,
